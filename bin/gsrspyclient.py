...
# p = plugins['substances_exist'].Plugin()

plugins['add_concepts_example'] = importlib.import_module('plugins.add_concepts_example')
# p = plugins['add_concepts_example'].Plugin()
